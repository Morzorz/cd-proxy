...
cd-proxy is a local reverse proxy that sits between Claude Desktop (or any Anthropic API client) and third-party Anthropic-compatible backends (DeepSeek, etc.). It serves two HTTP servers:
